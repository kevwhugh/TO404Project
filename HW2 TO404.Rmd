...
ggplot(days, aes(day.x, overflow, group = day.x)) + geom_boxplot() + ylim(-50, 50) + geom_abline(slope = 0, intercept = 0) +xlab("Day") + ylab("Overflow") + ggtitle("Overflow by Days of the Week")
```
